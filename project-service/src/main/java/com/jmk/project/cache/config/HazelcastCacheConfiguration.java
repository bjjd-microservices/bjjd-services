package com.jmk.project.cache.config;
...
public class HazelcastCacheConfiguration {
	...
	private static final String PROJECT_CAHCE_BY_CODE = "projectCacheByCode";
	...
	private MapConfig projectCacheByCodeMapConfig() {
		final MapConfig mapConfig = new MapConfig(PROJECT_CAHCE_BY_CODE);
